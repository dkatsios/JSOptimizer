...
public static Logger      logger_ ;      // Logger object
  ...
  public static void main(String [] args) throws
    ...
    fileHandler_ = new FileHandler(JSObjectsCreator.mainPath + algorithmName + ".log");
    logger_.addHandler(fileHandler_) ;

    Properties configuration = new Properties();
    InputStreamReader isr = new InputStreamReader(new FileInputStream(JSObjectsCreator.mainPath + algorithmName + ".conf"));
